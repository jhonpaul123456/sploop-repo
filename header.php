...
<!-- END: Top Contacts -->
    ...
    <?php
    $sql = "SELECT  `id`,`description`, ifnull(`file`,'') as `file` FROM top_main_menu  order by id";
...
<li class=" nk-drop-item">
       ...
       <ul class="dropdown">   
               ...
               $sql_class = "SELECT  `id`,`description`, ifnull(`file`,'') as `file` FROM top_class_menu where main_id ='".$row['id']."' ";
               ...
               if ($result_class->num_rows > 0) {
                ...
                while($row_class = $result_class->fetch_assoc()) {
                    ...
                    if ($row_class["file"] <> ''){
                                ?>
                                    <li>
                                        <a href="<?php echo $row_class["file"];?>">
                            ...
                            ?>
                                <li class="nk-drop-item">
                                    ...
                                    <ul class="dropdown">  
                                        <?php
                                              $sql_sub = "SELECT  `id`,`description`, ifnull(`file`,'') as `file` FROM top_sub_menu where class_id ='".$row_class['id']."' ";
                                              ...
                                              if ($result_sub->num_rows > 0) {
                                               ...
                                               {
                                                        ?>                                                                         
                                                    <li><a href="<?php echo $row_sub["file"]; ?>"><?php echo $row_sub["description"]; ?></a></li>
                                                        <?php
                                               }
                                            }
